...
urlpatterns = [
    ...
    path('multi-crop/', views.UnifiedMultiPhotoCropView.as_view(), name='unified_multi_photo_crop'),
    path('process-multi-crop/', views.UnifiedProcessMultiCropView.as_view(), name='unified_process_multi_crop'),
    ...
    path('pdf/<int:pdf_id>/view/', views.CalendarPDFViewerByIdView.as_view(), name='view_pdf_by_id'),
